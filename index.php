...
if(isset($_POST['add_product'])){
    ...
    $insert_query=mysqli_query($conn, "insert into `product` (name, price, image) values
    ('$product_name', '$product_price', '$product_image')") or die ("insert query falied");
    if($insert_query){
